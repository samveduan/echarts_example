...
var _215=_214.panel;
var _216=_215.children(".eu-panel-header");
var _217=_215.children(".eu-panel-body");
var _218=_215.children(".eu-panel-footer");
if(_213){
...
var _22a=$(_224).siblings(".eu-panel-footer");
if(opts.border){
...
_210(_226.children(".eu-panel-header"));
_226.children(".eu-panel-body").addClass("panel-body-noheader");
}else{
if(opts.header){
$(opts.header).addClass("panel-header").prependTo(_226);
}else{
var _22b=_226.children(".eu-panel-header");
if(!_22b.length){
_22b=$("<div class=\"panel-header\"></div>").prependTo(_226);
}
if(!$.isArray(opts.tools)){
_22b.find("div.eu-panel-tool .eu-panel-tool-a").appendTo(opts.tools);
}
_22b.empty();
...
_226.children("div.eu-panel-body").removeClass("panel-body-noheader");
}
};
...
_226.children(".eu-panel-footer").remove();
...
var tool=_23c.children(".eu-panel-header").find("a.eu-panel-tool-restore");
if(tool.length){
opts.maximized=true;
}
...
var body=_24b.children(".eu-panel-body");
var tool=_24b.children(".eu-panel-header").find("a.eu-panel-tool-collapse");
if(opts.collapsed==true){
return;
}
body.stop(true,true);
...
var body=_24f.children(".eu-panel-body");
var tool=_24f.children(".eu-panel-header").find("a.eu-panel-tool-collapse");
...
var tool=_251.children(".eu-panel-header").find("a.eu-panel-tool-max");
if(opts.maximized==true){
return;
}
...
var tool=_257.children(".eu-panel-header").find("a.eu-panel-tool-max");
...
$(_259).panel("header").find("div.eu-panel-title").html(_25a);
};
var _25b=null;
...
return $.data(jq[0],"panel").panel.children(".eu-panel-header");
},footer:function(jq){
return jq.panel("panel").children(".eu-panel-footer");
},body:function(jq){
return $.data(jq[0],"panel").panel.children(".eu-panel-body");
...
return jq.each(function(){
_266(this,"body");
_266($(this).siblings(".eu-panel-footer")[0],"footer");
...
var p=$(el).parents(".eu-panel-"+type+":first");
...
var t=$(_26d);
var hh=t.children(".eu-panel-header,header");
var ff=t.children(".eu-panel-footer,footer");
...
_293.window.draggable({handle:">div.eu-panel-header>div.eu-panel-title",disabled:_293.options.draggable==false,onBeforeDrag:function(e){
if(_293.mask){
...
var tool=_2ef.children("div.eu-panel-tool");
tool.children("a.eu-panel-tool-collapse").hide();
...
var tool=$(this).panel("header").children("div.eu-panel-tool");
tool.children("a.eu-panel-tool-collapse").hide();
